    ...
    <div className="py-32 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-5 justify-center">
            <Link to="/apply" className="bg-[#1e22aa] hover:bg-[#151885] text-white font-bold py-4 px-10 rounded-lg shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 text-lg">
