      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal delay={400}>
          <a 
            ...
            className="bg-white text-brand hover:bg-blue-50 font-bold py-5 px-12 rounded-lg shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] hover:shadow-2xl transition-all transform hover:-translate-y-1 text-xl flex items-center justify-center gap-3 mx-auto min-w-[300px]"
          >
            <svg viewBox="0 0 109.5 124.5" className="w-8 h-8">
              ...
              <path fill="#5E8E3E" d="M78.1,123.9l31.4-7.8c0,0-13.5-91.3-13.6-91.9c-0.1-0.6-0.6-1-1.1-1c-0.5,0-9.3-0.2-9.3-0.2 s-5.4-5.2-7.4-7.2V123.9z"/>
            </svg>
