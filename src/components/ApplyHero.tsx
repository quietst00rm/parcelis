      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal delay={400}>
          <a
            ...
            className="bg-white text-brand hover:bg-blue-50 font-bold py-3 px-8 rounded-md shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 text-lg flex items-center justify-center gap-3 mx-auto w-auto inline-flex"
          >
            <svg viewBox="0 0 109.5 124.5" className="w-6 h-6">
              <path
                fill="#95BF47"
