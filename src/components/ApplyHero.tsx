      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal delay={400}>
          <a
            ...
            // CHANGED: py-4 px-10 (bigger), text-xl (bigger text), rounded-md (less round)
            className="bg-white text-brand hover:bg-blue-50 font-bold py-4 px-10 rounded-md shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 text-xl flex items-center justify-center gap-3 mx-auto w-auto inline-flex"
          >
