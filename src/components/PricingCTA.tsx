    ...
    <div className="bg-brand py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col items-center gap-6">
            <button className="bg-white text-brand hover:bg-blue-50 font-bold py-4 px-12 rounded-lg shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1 text-lg">
                Apply Now
            </button>
